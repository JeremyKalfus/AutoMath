# Salvage: five-regular-pseudograph-4-1-factor

- stage: `solve_five-regular-pseudograph-4-1-factor`
- failure_reason: `solve_timeout`
- timed_out: `True`
- timeout_secs: `300`
- salvaged_on: `2026-04-13T00:35:01.807427-04:00`
- stdout_log: `artifacts/_logs/20260413T003001_solve_five-regular-pseudograph-4-1-factor.stdout.log`
- last_message_path: `artifacts/_logs/20260413T003001_solve_five-regular-pseudograph-4-1-factor.last.txt`
...
- artifacts/five-regular-pseudograph-4-1-factor/working_packet.md
...
+
+# family_affinity
+High. This instance sits exactly at the low-degree endpoint of the regular `{a,b}`-factor family, and the proof template is clearly “equivalent residue + local reducibility” rather than a broad family campaign.
+
...
[run_stage timeout after 300 seconds]
